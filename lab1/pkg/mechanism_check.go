...
func MechanismCheck() {
	...
	message := []uint64{0x92def06b3c130a59, 0xdb54c704f8189d20, 0x4a98fb2e67a8024c, 0x8912409b17b57e41}
	...
	if Omac(message, key, 4) == uint64(0x154e7210) && (result512 == sum512) && (result256 == sum256) {
